...
class ToontownChatManager(ChatManager.ChatManager):
    ...
    def __init__(self, cr, localAvatar):
        ...
        self.normalButton = DirectButton(image=(gui.find('**/ChtBx_ChtBtn_UP'),
                                                gui.find('**/ChtBx_ChtBtn_DN'),
                                                gui.find('**/ChtBx_ChtBtn_RLVR')),
                                         pos=(0.08, 0, -0.07), scale=1.179,
                                         relief=None, image_color=Vec4(1, 1, 1, 1),
                                         ...
                                         text_pos=(-0.0525, -0.09), textMayChange=0, parent=base.a2dTopLeft,
        ...
        self.scButton = DirectButton(image=(gui.find('**/ChtBx_ChtBtn_UP'), gui.find('**/ChtBx_ChtBtn_DN'),
                                            gui.find('**/ChtBx_ChtBtn_RLVR')),
                                     pos=TTLocalizer.TCMscButtonPos, scale=1.179,
                                     relief=None, image_color=Vec4(0.75, 1, 0.6, 1),
                                     text=('', OTPLocalizer.GlobalSpeedChatName, OTPLocalizer.GlobalSpeedChatName),
                                     text_scale=TTLocalizer.TCMscButton, text_fg=Vec4(1, 1, 1, 1),
                                     text_shadow=Vec4(0, 0, 0, 1), text_pos=(0, -0.09), parent=base.a2dTopLeft,
                                     textMayChange=0, sortOrder=DGG.FOREGROUND_SORT_INDEX,
                                     command=self.__scButtonPressed, clickSound=self.openScSfx)
        self.scButton.hide()
        self.whisperFrame = DirectFrame(parent=base.aspect2d, relief=None, image=DGG.getDefaultDialogGeom(),
                                        image_scale=(0.45, 0.45, 0.45), image_color=OTPGlobals.GlobalDialogColor,
                                        pos=(0, 0, 0), text=OTPLocalizer.ChatManagerWhisperTo,
                                        text_wordwrap=7.0, text_scale=TTLocalizer.TCMwhisperFrame,
                                        text_fg=Vec4(0, 0, 0, 1), text_pos=(0, 0.14),
                                        textMayChange=1, sortOrder=DGG.FOREGROUND_SORT_INDEX)
        self.whisperFrame.hide()
        self.whisperButton = DirectButton(parent=self.whisperFrame, image=(gui.find('**/ChtBx_ChtBtn_UP'),
                                                                           gui.find('**/ChtBx_ChtBtn_DN'),
                                                                           gui.find('**/ChtBx_ChtBtn_RLVR')),
                                          pos=(-0.125, 0, -0.1), scale=1.179, relief=None,
                                          image_color=Vec4(1, 1, 1, 1), text=('',
        ...
        self.whisperScButton = DirectButton(parent=self.whisperFrame, image=(gui.find('**/ChtBx_ChtBtn_UP'),
                                                                             gui.find('**/ChtBx_ChtBtn_DN'),
                                                                             gui.find('**/ChtBx_ChtBtn_RLVR')),
        ...
        self.whisperCancelButton = DirectButton(parent=self.whisperFrame, image=(gui.find('**/CloseBtn_UP'),
                                                ...
                                                text=('',
                                                      ...
                                                      OTPLocalizer.ChatManagerCancel),
                                                text_scale=0.05, text_fg=(0, 0, 0, 1), text_pos=(0, -0.09),
                                                textMayChange=0, command=self.__whisperCancelPressed)
        gui.removeNode()
        ...
        self.normalPos = Vec3(0.25, 0, -0.2)
    ...
    def sendSCToontaskWhisperMessage(self, taskId, toNpcId, toonProgress, msgIndex, whisperAvatarId, toPlayer):
        if toPlayer:
            base.talkAssistant.sendPlayerWhisperToonTaskSpeedChat(taskId, toNpcId,
                                                                  toonProgress, msgIndex, whisperAvatarId)
        else:
    ...
    def enterOpenChatWarning(self):
        if self.openChatWarning == None:
            ...
            self.openChatWarning = DirectFrame(parent=base.a2dTopLeft, pos=(0.1, 0, -0.08), relief=None,
                                               ...
                                               text_pos=(0.0, 0.575), textMayChange=0)
            DirectButton(self.openChatWarning, image=buttonImage, relief=None, text=OTPLocalizer.OpenChatWarningOK,
                         text_scale=0.05, text_pos=(0.0, -0.1), textMayChange=0,
                         pos=(0.0, 0.0, -0.55), command=self.__handleOpenChatWarningOK)
            buttons.removeNode()
    ...
    def enterActivateChat(self):
        if self.activateChatGui == None:
            ...
            self.activateChatGui = DirectFrame(parent=aspect2dp, pos=(0.1, 0, -0.8),
                                               relief=None, image=DGG.getDefaultDialogGeom(),
